...
export function GraphExplorer({
  ...
  return <div className="workspace-view graph-view orbit-explorer">
    ...
    <div className="explorer-canvas-shell">
      ...
      <div className="explorer-status"><span>Showing {data.nodes.length.toLocaleString("de-DE")} of {graph.nodes.length.toLocaleString("de-DE")} objects · {data.links.length.toLocaleString("de-DE")} visible links</span><span>{mode === "2d" ? "Drag to move · Wheel to zoom · Double-click a node to expand" : "Drag to rotate · Right-drag to pan · Wheel to zoom · Double-click to expand"}</span></div>
    </div>
  </div>;
}
